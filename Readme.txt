...
As my training and testing dataset, I have used the Bengali Dataset from a research paper where they have curated publicly available data from the internet: 
